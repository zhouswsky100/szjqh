<template>
  <div>
    <div class="minh600"  style="width:2200px"> 
      <el-table
        :data="tableData"
        border
        fit
        ...
        <el-table-column
         ...
         <el-table-column
          ...
          align="center">
          <template scope="scope">
            <span style="margin-left: 10px" >{{ scope.row.nfpath | filterUrl}}</span>
          </template>
        </el-table-column>
          <el-table-column
          label="搜索关键词"
          ...
          align="center">
          <template scope="scope">
            <span style="margin-left: 10px" >{{ scope.row.guanjianci}}</span>
          </template>
        </el-table-column>
          <el-table-column
          label="网站标题"
          ...
          align="center">
          <template scope="scope">
            <span style="margin-left: 10px" >{{ scope.row.webtitle }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="发布时间"
        ...
        <el-table-column
          ...
          <template scope="scope">
            ...
            <el-button
              size="small"
              @click="updateSeek(scope.row.ndate,scope.row.nstitle,scope.row.ncontent,scope.row.ntype,scope.row.nid,scope.row.ntitle ,scope.row.guanjianci,scope.row.webtitle)">修改
            </el-button>
             <el-button
              size="small"
      ...
      <el-dialog title="添加新闻" v-model="dialogVisible" :show-close="true" width="30%">
          <el-form :model="newsForm" ref="newsForm" :rules="rules">
            ...
            <el-form-item label="新闻标题" label-width="100px" prop="title">
              <el-input v-model="newsForm.title"></el-input>
                ...
                <el-form-item label="搜索关键词" label-width="100px" prop="guanjianci">
              <el-input v-model="newsForm.guanjianci"></el-input>
            </el-form-item>
            <el-form-item label="网站标题" label-width="100px" prop="webtitle">
              <el-input v-model="newsForm.webtitle"></el-input>
            </el-form-item>
        ...
        <el-dialog title="修改新闻" v-model="upDialogVisible" :show-close="true" size="" >
          <el-form :model="UpnewsForm" ref="UpnewsForm" :rules="rules">
            ...
            <el-form-item label="搜索关键词" label-width="100px" prop="guanjianci">
              <el-input v-model="UpnewsForm.guanjianci"></el-input>
            </el-form-item>
            <el-form-item label="网站标题" label-width="100px" prop="webtitle">
              <el-input v-model="UpnewsForm.webtitle"></el-input>
            </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      updateSeek(ndate,nstitle,ncontent,ntype,nid,title,guanjianci,webtitle){
        var self= this;
         self.UpnewsForm= {
                  type: '',
                  cont: ncontent,
      ...
      addNews (){
          ...
          var data = {
              ...
              "guanjianci":self.newsForm.guanjianci,
              "webtitle":self.newsForm.webtitle
            };
          let opt = {
       ...
       upNews (){
          ...
          var data = {
             ...
             "nid":self.UpnewsForm.nid,
              "guanjianci":self.UpnewsForm.guanjianci,
              "webtitle":self.UpnewsForm.webtitle
    ...
    filters: {
        ...
        filterNewsTime(value){
         ...
         filterUrl(value){
          return  configUrl.templateUrl+value
        }
    },
  }
